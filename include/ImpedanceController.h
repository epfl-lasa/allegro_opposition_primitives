...
public:
  ...
  void         SetJointEffortMask(int joint_id, Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> mask);
...
protected:
  ...
  std::vector<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> > e_jointEffortMask;
};
